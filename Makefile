.PHONY: help bootstrap setup doctor dev fix format lint typecheck test build smoke check release-check clean
...
help:
	...
	@printf '%s\n' '  make dev            Fail-loud placeholder until Phase 2 creates the app.'
...
dev:
	@printf '%s\n' 'ERROR: make dev is intentionally unavailable until Phase 2 creates the Next.js app shell.' >&2
	@exit 1
